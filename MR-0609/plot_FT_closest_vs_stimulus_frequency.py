...
for key in tqdm(keys):
    ...
    if  data[key]['response'] == 'yes':
        ...
        fig.suptitle(f'Closest peaks found in the power spect')
        ...
        for ix,cm in enumerate(contrasts):
            ...
            axt.set_xlabel('ft')
            axt.set_ylabel('closest peak in FFT')
        ...
        # ========================================================================================================================================================================
            ...
            try:
                ...
                fpplots = f'/user/sebert/home/Documents/Experiments/Spatiotemporal_tuning_curves/Results/{exp_name}/plots/gratings/FFT/closest'
